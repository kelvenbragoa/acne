...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="{{asset('template/css/elegant-font-icons.css')}}">
        <!-- Elegant Line Icons CSS -->
        <link rel="stylesheet" href="{{asset('template/css/elegant-line-icons.css')}}">
		<!-- Bootstrap CSS -->
        <link rel="stylesheet" href="{{asset('template/css/bootstrap.min.css')}}">
		<!-- Venobox CSS -->
        <link rel="stylesheet" href="{{asset('template/css/venobox/venobox.css')}}">
		<!-- OWL-Carousel CSS -->
        <link rel="stylesheet" href="{{asset('template/css/owl.carousel.css')}}">
        <!-- Slick Nav CSS -->
        <link rel="stylesheet" href="{{asset('template/css/slicknav.min.css')}}">
        <!-- Css Animation CSS -->
        <link rel="stylesheet" href="{{asset('template/css/css-animation.min.css')}}">
        <!-- Nivo Slider CSS -->
        <link rel="stylesheet" href="{{asset('template/css/nivo-slider.css')}}">
		<!-- Main CSS -->
